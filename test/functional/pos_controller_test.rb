...
class PosControllerTest < ActionController::TestCase
  ...
  test "should create po" do
    assert_difference('Po.count') do
      post :create, po: { category: @po.category, name: @po.name, price: @po.price, quantity: @po.quantity }
    end
  ...
  test "should update po" do
    put :update, id: @po, po: { category: @po.category, name: @po.name, price: @po.price, quantity: @po.quantity }
    assert_redirected_to po_path(assigns(:po))
  end
